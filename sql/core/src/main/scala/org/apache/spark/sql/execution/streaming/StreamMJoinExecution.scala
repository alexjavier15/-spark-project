...
import org.apache.spark.sql.util.ContinuousQueryListener.{QueryProgress, QueryStarted, QueryTerminated, _}
/**
...
class StreamMJoinExecution(
  ...
  private def runBatches(): Unit = {
    try {
      ...
      state = TERMINATED
      sqlContext.streams.notifyQueryTermination(StreamMJoinExecution.this)
...
private[sql] object StreamMJoinExecution {
